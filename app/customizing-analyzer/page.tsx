...
export default function CustomizingAnalyzerPage() {
  ...
  const handleAnalyze = async () => {
    ...
    if (!text.trim()) {
      setError("Bitte Customizing-Tabellen, IMG-Pfade oder Einstellungen eingeben.");
      return;
    }
  ...
  return (
    <main className="mx-auto max-w-[1400px] px-6 py-10">
      <h1 className="text-3xl font-semibold mb-4">Customizing Analyzer</h1>
      <p className="text-sm text-gray-500 mb-6">
        Analysiere IMG-Pfade, Tabellen, Einstellungen und Customizing-Konfigurationen.
      </p>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="flex flex-col">
          ...
          <textarea
            ...
            placeholder="z.B. Tabelle T001, IMG-Pfad, Customizing-Parameter..."
          />
          <button
        ...
        <div className="flex flex-col">
          ...
          <div className="border rounded-md p-3 min-h-[260px] text-sm whitespace-pre-wrap bg-gray-50">
            {loading && "Die KI analysiert dein Customizing..."}
