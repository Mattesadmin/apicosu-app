...
export default function ErrorFinderPage() {
  ...
  const handleAnalyze = async () => {
    ...
    if (!text.trim()) {
      setError("Bitte einen Fehlertext, Dump, Log oder Meldung eingeben.");
      return;
    }
  ...
  return (
    <main className="mx-auto max-w-[1400px] px-6 py-10">
      <h1 className="text-3xl font-semibold mb-4">Error Finder</h1>
      <p className="text-sm text-gray-500 mb-6">
        Füge hier SAP-Fehler, Dumps, Logs oder Systemmeldungen ein. Die KI analysiert Ursachen und liefert Lösungsvorschläge.
      </p>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="flex flex-col">
          ...
          <textarea
            ...
            placeholder="z.B. ST22 Dump, SM21 Log, Transportfehler, ABAP-Fehlermeldung..."
          />
          <button
        ...
        <div className="flex flex-col">
          ...
          <div className="border rounded-md p-3 min-h-[260px] text-sm whitespace-pre-wrap bg-gray-50">
            {loading && "Die KI analysiert den Fehler..."}
