...
export default function TestdatenGeneratorPage() {
  ...
  return (
    <div className="space-y-10">
      <h1 className="text-3xl font-semibold">Testdaten Generator</h1>
      ...
      <UploadBox
        ...
        placeholder="Szenarien, Tabellenstrukturen oder Beispiel‑Daten..."
      />

      <Button onClick={generate} disabled={loading}>
        {loading ? "Generiere..." : "Testdaten erzeugen"}
      </Button>
      ...
      <ResultBox
        ...
        loading={loading}
        error={error}
        emptyLabel="Noch keine Testdaten erzeugt."
      />
    </div>
  );
}
