...
export default function BlueprintGeneratorPage() {
  ...
  const handleAnalyze = async () => {
    ...
    if (!text.trim()) {
      setError("Bitte Prozessbeschreibung, Anforderungen oder Systemdetails eingeben.");
      return;
    }
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setError(data.error || "Fehler bei der Blueprint-Erstellung.");
      } else {
  ...
  return (
    <main className="mx-auto max-w-[1400px] px-6 py-10">
      <h1 className="text-3xl font-semibold mb-4">Blueprint Generator</h1>
      <p className="text-sm text-gray-500 mb-6">
        Erstelle Prozessbeschreibungen, Rollenmodelle, Testfälle und technische Blueprints.
      </p>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="flex flex-col">
          ...
          <textarea
            ...
            placeholder="z.B. Prozessbeschreibung, Anforderungen, Systemdetails..."
          />
          <button
          ...
          >
            {loading ? "Erstelle Blueprint..." : "Blueprint generieren"}
          </button>
          {error && (
        ...
        <div className="flex flex-col">
          ...
          <div className="border rounded-md p-3 min-h-[260px] text-sm whitespace-pre-wrap bg-gray-50">
            {loading && "Die KI erstellt deinen Blueprint..."}
            {!loading && output && output}
            {!loading && !output && !error && (
              <span className="text-gray-400">
                Noch kein Blueprint erstellt.
              </span>
            )}
          </div>
        </div>
