...
export default function BlueprintGeneratorPage() {
  ...
  return (
    <div className="space-y-10">
      <h1 className="text-3xl font-semibold">Blueprint Generator</h1>
      ...
      <UploadBox
        ...
        placeholder="Prozessbeschreibung, Anforderungen oder Dokumente..."
      />
      ...
      <ResultBox
        ...
        loading={loading}
        error={error}
        emptyLabel="Noch kein Blueprint erzeugt."
      />
    </div>
  );
}
